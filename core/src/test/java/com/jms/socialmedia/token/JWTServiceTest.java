...
public class JWTServiceTest {
	...
	public void testJWTService() throws IOException {
		...
		Token token = Token.newBuilder().setUserId(5).setUsername("Me").addPermissions(Permission.ADD_POST, Permission.DELETE_COMMENT).build();
		...
		assertThat(token2.getUsername(), is("Me"));
