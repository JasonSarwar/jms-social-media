...
public class CoreSettings {
	...
	public static final Setting<Integer> CACHING_MAX_NUMBER_OF_POSTS = integerSettingWithDefault("caching.max_number_of_posts", 50);
	...
	public static final Setting<Boolean> LOG_REQUESTS_AND_RESPONSES = booleanSettingWithDefault("log.requests_and_responses", true);
